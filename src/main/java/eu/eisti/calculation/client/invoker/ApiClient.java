package eu.eisti.calculation.client.invoker;
...
import eu.eisti.calculation.client.invoker.auth.Authentication;
import eu.eisti.calculation.client.invoker.auth.HttpBasicAuth;
